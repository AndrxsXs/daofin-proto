  ...
  return (
    <div className="w-full h-max flex">
      <article className="w-full h-full flex flex-col">
        <header className="flex justify-between items-center w-full gap-5 mt-5 pt-5 pb-5 bg-shark-950 sticky top-0 z-50">
        ...
        <div className="w-full h-full flex justify-between gap-5">
          ...
          <section className="py-5 flex flex-col gap-5 min-w-72 h-screen sticky top-20 right-0">
            <Card className="px-5 bg-fuchsia-500">
      ...
      {/* <article className="max-w-80 w-full h-full pl-5 sticky right-0 top-0 py-5"> */}
      {/* <div className="flex gap-5 justify-end">
          <Button isIconOnly variant="plain" radius="full">
            <ChatBubbleLeftEllipsisIcon className="w-6 h-6" />
          </Button>
